...
<div align=center>
<img src="../../figure/操作系统笔记/Chapter8-Deadlocks/system_model.webp" width=700>
</div>
...
<div align=center>
<img src="../../figure/操作系统笔记/Chapter8-Deadlocks/resource_allocation_graph_instance.webp" width=500>
</div>
...
<div align=center>
<img src="../../figure/操作系统笔记/Chapter8-Deadlocks/RAG_with_a_deadlock.webp" width=300>
</div>

有环有死锁
<div align=center>
<img src="../../figure/操作系统笔记/Chapter8-Deadlocks/RAG_without_deadlock.webp" width=300>
</div>
...
<div align=center>
<img src="../../figure/操作系统笔记/Chapter8-Deadlocks/claim_no_cycle.webp" width=400>
</div>
从图中可以看出加了申请边(claim edge)之后不会导致成环(cycle)，所以可以加入这两条边。
<div align=center>
<img src="../../figure/操作系统笔记/Chapter8-Deadlocks/claim_with_cycle.webp" width=400>
</div>
从图中可以看出加了申请边(claim edge)之后会导致成环(cycle)，所以不能加入这两条边。
<div align=center>
<img src="../../figure/操作系统笔记/Chapter8-Deadlocks/wait_for_graph.webp" width=500>
</div>
...
<div align=center>
<img src="../../figure/操作系统笔记/Chapter8-Deadlocks/bank_algo_current_state.webp" width=500>
</div>

The content of the matrix Need is defined to be Max − Allocation and is as follows:
<div align=center>
<img src="../../figure/操作系统笔记/Chapter8-Deadlocks/bank_algo_needs.webp" width=180>
</div>
