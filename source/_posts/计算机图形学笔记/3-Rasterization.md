...
屏幕的空间如图所示，
<div align=center>
<img src='../../figure/计算机图形学笔记/3-Rasterization/screen_space.webp' width=500>
</div>
...
<div align=center>
<img src='../../figure/计算机图形学笔记/3-Rasterization/lcd.webp' width=400>
</div>
...
<div align=center>
<img src='../../figure/计算机图形学笔记/3-Rasterization/2d_sampling.webp' width=400>
</div>
...
<div align=center>
<img src='../../figure/计算机图形学笔记/3-Rasterization/bounding_box.webp' width=400>
</div>
...
直接采样：
<div align=center>
<img src='../../figure/计算机图形学笔记/3-Rasterization/sample.webp' width=600>
</div>

先模糊处理后再采样
<div align=center>
<img src='../../figure/计算机图形学笔记/3-Rasterization/pre_filter_sample.webp' width=600>
</div>
...
由傅里叶展开可以引出傅里叶变换
<div align=center>
<img src='../../figure/计算机图形学笔记/3-Rasterization/fourier_transform.webp' width=600>
</div>
...
用同一频率采样不同频率的函数：
<div align=center>
<img src='../../figure/计算机图形学笔记/3-Rasterization/higher_frequenies_faster_sampling.webp' width=600>
</div>

可以看出采样频率相同时，如果函数的频率过大，那么采样将会丢失很多信息。同时过低的采样频率可能会导致两个频率截然不同的函数被采样之后得到完全相同的结果：
<div align=center>
<img src='../../figure/计算机图形学笔记/3-Rasterization/undersampling.webp' width=600>
</div>
...
<div align=center>
<img src='../../figure/计算机图形学笔记/3-Rasterization/frequency_content.webp' width=600>
</div>
...
<div align=center>
<img src='../../figure/计算机图形学笔记/3-Rasterization/high_pass_filter.webp' width=600>
</div>
...
<div align=center>
<img src='../../figure/计算机图形学笔记/3-Rasterization/low_pass_filter.webp' width=600>
</div>

如果同时过滤最高频和最低频的信号，会得到结果如下
<div align=center>
<img src='../../figure/计算机图形学笔记/3-Rasterization/mid_pass_filter.webp' width=600>
</div>
...
<div align=center>
<img src='../../figure/计算机图形学笔记/3-Rasterization/convolution_theorem.webp' width=600>
</div>

同时对于卷积操作来说，卷积核在时域上越大，那么在频域中就越小。(可以理解为卷积核如果很大，那么相当于会把整张图片弄得很模糊，也就是去掉了所有高频信息，这说明在频域中应该很小)
<div align=center>
<img src='../../figure/计算机图形学笔记/3-Rasterization/samll_box.webp' width=600>
</div>

<div align=center>
<img src='../../figure/计算机图形学笔记/3-Rasterization/large_box.webp' width=600>
</div>

### Sampling = Repeating Frequency Contents
对信号做采样，就相当于让信号乘以一系列的冲激函数。而在频域中，就相当于让函数与一系列冲激函数做卷积，最终得到的结果就是频域中的函数被重复。
<div align=center>
<img src='../../figure/计算机图形学笔记/3-Rasterization/repeating_frequency_content.webp' width=600>
</div>

如果在时域中采样频率过低，那么在频域中冲激函数的间隔就会比较小，最终就会导致频域中的函数重叠。而如果对图像进行模糊处理，相当于截掉了高频部分，那么就能避免重叠。

<div align=center>
<img src='../../figure/计算机图形学笔记/3-Rasterization/mix_frequency_contents.webp' width=600>
</div>
...
<div align=center>
<img src='../../figure/计算机图形学笔记/3-Rasterization/pixel_filter.webp' width=600>
</div>
...
<div align=center>
<img src='../../figure/计算机图形学笔记/3-Rasterization/super_sampling.webp' width=600>
</div>

最后得到结果如图：
<div align=center>
<img src='../../figure/计算机图形学笔记/3-Rasterization/super_sampling_result.webp' width=600>
</div>
...
<div align=center>
<img src='../../figure/计算机图形学笔记/3-Rasterization/unresolvable_condition.webp' width=300>
</div>
...
#### Z-Buffer Example
<div align=center>
<img src='../../figure/计算机图形学笔记/3-Rasterization/z-buffer_example.webp' width=600>
</div>
