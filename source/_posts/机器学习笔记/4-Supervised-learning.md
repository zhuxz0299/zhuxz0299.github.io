...
### Perceptron model
M-P neuron model:
<img src='../../figure/机器学习笔记/4-Supervised-learning/mp-neuron-model.webp' width=450 style="display: block; margin-left: auto; margin-right: auto;">

Perceptron 就是 Input layer + M-P neuron (output)
<img src='../../figure/机器学习笔记/4-Supervised-learning/perceptron.webp' width=350 style="display: block; margin-left: auto; margin-right: auto;">

Perceptron 可以做一些逻辑运算：
* OR
  <img src='../../figure/机器学习笔记/4-Supervised-learning/perceptron_or.webp' width=350 style="display: block; margin-left: auto; margin-right: auto;">
* AND
  <img src='../../figure/机器学习笔记/4-Supervised-learning/perceptron_and.webp' width=350 style="display: block; margin-left: auto; margin-right: auto;">
* NOT
  <img src='../../figure/机器学习笔记/4-Supervised-learning/perceptron_not.webp' width=350 style="display: block; margin-left: auto; margin-right: auto;">

#### XOR 
单个 perception 做的是线性的划分，因此无法解决 XOR 的问题。
<img src='../../figure/机器学习笔记/4-Supervised-learning/single_perceptron.webp' width=450 style="display: block; margin-left: auto; margin-right: auto;">

但是使用 two-layer perception 即可。
<img src='../../figure/机器学习笔记/4-Supervised-learning/two-layer-perceptron.webp' width=450 style="display: block; margin-left: auto; margin-right: auto;">
...
该算法迭代的过程如下图所示：
<img src='../../figure/机器学习笔记/4-Supervised-learning/perceptron_algo.webp' width=450 style="display: block; margin-left: auto; margin-right: auto;">

### Neural network
#### The multilayer perceptron
<img src='../../figure/机器学习笔记/4-Supervised-learning/multilayer_perceptron.webp' width=450 style="display: block; margin-left: auto; margin-right: auto;">
...
<img src='../../figure/机器学习笔记/4-Supervised-learning/test_error.webp' width=450 style="display: block; margin-left: auto; margin-right: auto;">
