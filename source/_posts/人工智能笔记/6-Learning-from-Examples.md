...
<img src='../../figure/人工智能笔记/6-Learning-from-Examples/Regularized_least_squares.webp' width=400 style="display: block; margin-left: auto; margin-right: auto;"> 
...
<img src='../../figure/人工智能笔记/6-Learning-from-Examples/polynomial_curve.webp' width=300 style="display: block; margin-left: auto; margin-right: auto;"> 

假如想拟合图上的这些点。如果多项式的次数太低，那么可能会导致欠拟合；如果多项式次数过高，可能会导致过拟合。欠拟合和过拟合的效果如图：
<div style="text-align: center;">
  <img src='../../figure/人工智能笔记/6-Learning-from-Examples/first_order.webp' height=200 style="display: inline-block; margin-right: 10px;">
  <img src='../../figure/人工智能笔记/6-Learning-from-Examples/ninth_order.webp' height=200 style="display: inline-block; margin-right: 10px;">
</div>

如果发现欠拟合，那么可以增加次数；如果发现过拟合，可以减少次数(降低模型复杂度)，增加样本数量，或者使用正则项。

我们先观察在不同次数的情况下拟合得到的系数：
<img src='../../figure/人工智能笔记/6-Learning-from-Examples/polynomial_coefficients.webp' width=400 style="display: block; margin-left: auto; margin-right: auto;"> 
...
<img src='../../figure/人工智能笔记/6-Learning-from-Examples/lambda_regularization.webp' width=300 style="display: block; margin-left: auto; margin-right: auto;"> 
