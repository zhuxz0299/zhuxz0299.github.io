...
<img src='../../figure/数据科学基础笔记/5-Feature-Encoding/object_proposal.webp' width=300 style="display: block; margin-left: auto; margin-right: auto;">
...
<img src='../../figure/数据科学基础笔记/5-Feature-Encoding/video_trajectories.webp' width=400 style="display: block; margin-left: auto; margin-right: auto;">
...
<img src='../../figure/数据科学基础笔记/5-Feature-Encoding/learn_codebook.webp' width=400 style="display: block; margin-left: auto; margin-right: auto;">

* 基于学到的 codebook 将局部特征进行编码
  * 下图展现最简单的方法：统计一个 bag 的某一种 local feature 出现了多少次
<img src='../../figure/数据科学基础笔记/5-Feature-Encoding/encode_local_feature.webp' width=400 style="display: block; margin-left: auto; margin-right: auto;">
...
<img src='../../figure/数据科学基础笔记/5-Feature-Encoding/example_learn_codebook.webp' width=500 style="display: block; margin-left: auto; margin-right: auto;">

然后使用 codebook 对每张杯子图片的 local feature 进行 encoding。
<img src='../../figure/数据科学基础笔记/5-Feature-Encoding/example_encoding.webp' width=500 style="display: block; margin-left: auto; margin-right: auto;">
...
<img src='../../figure/数据科学基础笔记/5-Feature-Encoding/bow.webp' width=500 style="display: block; margin-left: auto; margin-right: auto;">
...
<img src='../../figure/数据科学基础笔记/5-Feature-Encoding/vlad.webp' width=600 style="display: block; margin-left: auto; margin-right: auto;">
